...
import {
  ...
  MOCK_TRACE_SEARCH_QUERY_RESULT,
  MOCK_EMPTY_TRACE_SEARCH_QUERY_RESULT,
} from '../../test/';
...
describe('ScatterChartPanel', () => {
  ...
  it('should render a ScatterPlot', async () => {
    (useDataQueries as jest.Mock).mockReturnValue({
      queryResults: MOCK_TRACE_SEARCH_QUERY_RESULT,
      isLoading: false,
      isFetching: false,
    });
    renderPanel();
  ...
  it('should not render a ScatterPlot because trace results are empty', async () => {
    (useDataQueries as jest.Mock).mockReturnValue({
      queryResults: MOCK_EMPTY_TRACE_SEARCH_QUERY_RESULT,
      isLoading: false,
      isFetching: false,
    });
    renderPanel();
