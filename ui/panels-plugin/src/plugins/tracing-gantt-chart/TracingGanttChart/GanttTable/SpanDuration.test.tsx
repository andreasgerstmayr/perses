...
describe('SpanDuration', () => {
  ...
  it('render span bar', () => {
    renderComponent({
      ...
      viewport: {
        startTimeUnixMs: MOCK_GANTT_TRACE.rootSpan.startTimeUnixMs,
        endTimeUnixMs: MOCK_GANTT_TRACE.rootSpan.endTimeUnixMs,
      },
    });
  ...
  it('render span bar duration on left side', () => {
    renderComponent({
      ...
      span: MOCK_GANTT_TRACE.rootSpan.childSpans[0]!.childSpans[0]!,
      viewport: {
        startTimeUnixMs: MOCK_GANTT_TRACE.rootSpan.startTimeUnixMs + 290,
        endTimeUnixMs: MOCK_GANTT_TRACE.rootSpan.startTimeUnixMs + 400,
      },
    });
    expect(screen.getByText('150ms')).toBeInTheDocument();
