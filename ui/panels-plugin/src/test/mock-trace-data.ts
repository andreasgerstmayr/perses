...
export const MOCK_EMPTY_TRACE_SEARCH_RESULT: TraceData = {
  searchResult: [],
  metadata: {
    executedQueryString: '{duration > 500ms}',
  },
 ...
 * handle fetching.
 */
export const MOCK_TRACE_SEARCH_QUERY_RESULT = [
  {
    status: 'success',
    fetchStatus: 'idle',
    isLoading: false,
...
export const MOCK_EMPTY_TRACE_SEARCH_QUERY_RESULT = [
  {
    status: 'success',
    fetchStatus: 'idle',
    isLoading: false,
    isSuccess: true,
    isError: false,
    data: MOCK_EMPTY_TRACE_SEARCH_RESULT,
    dataUpdatedAt: 1666500979895,
    error: null,
    errorUpdatedAt: 0,
    failureCount: 0,
